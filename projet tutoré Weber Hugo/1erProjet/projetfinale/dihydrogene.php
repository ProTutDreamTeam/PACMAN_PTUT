...
<body>
  ...
  <main>
    <p>Une autre alternative bien connu est le dihydrogène. Parmi tous les combustibles verts, le dihydrogène est considéré comme le carburant plus propre et le plus efficace. Son utilisation est répandue dans plusieurs domaines, que ce soit dans le transport public avec la production de train à hydrogène ou encore dans le domaine de l’industrie, ou il est utilisé comme produit chimique dans une large gamme d’applications. Ne provoquant aucun rejet de matière toxique lorsqu’il est utilisé dans un véhicule, beaucoup le considèrent comme une des solutions les plus  viable pour l’avenir énergétique mais sa production reste malgré tout compliquée puisqu’elle nécessite l’utilisation d’énergie fossile.
</p>
    </main>
  <footer>
    <p>À propos</p>
